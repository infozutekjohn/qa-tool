...
trait S303LiveCasinoRetriesScenario
{
    
    private static array $LiveCasinoBetRetryPayload = [];
    private static array $LiveCasinoResultRetryPayload = [];

    #[Group('live')]
    #[ParentSuite('03. Gameslink Casino Tests (live flows)')]
    #[Suite('3.03 Regular gameround scenario with retries')]
    ...
    public function live_bet_retry(): void
    {
        ...
        self::$LiveCasinoBetRetryPayload = $payload;
    ...
    public function live_bet_with_retries(): void
    {
        ...
        $payload = self::$LiveCasinoBetRetryPayload; // retry payload
    ...
    public function live_result_win_retry(): void
    {
        ...
        self::$LiveCasinoResultRetryPayload = $payload;        
    ...
    public function live_result_win_with_retries(): void
    {
        ...
        $payload = self::$LiveCasinoResultRetryPayload; // retry payload
        $payload['requestId'] = uniqid('test_');      
        
        $transactionCode = $payload['pay']['transactionCode'];
        $this->assertNotNull($transactionCode, 'Transaction code from previous result not found');
