...
trait S412FreespinSpendScenario
{
    // 4.1.2 Freespin bonus round scenario without wagering (spend)
    #[Group('bonus')]
    #[ParentSuite('04. Gameslink Casino Tests (bonus flows)')]
    #[Suite('4.1 Free spins')]
    #[SubSuite('4.1.2 Freespin bonus round scenario without wagering (spend)')]
