...
trait S411FreespinHeldScenario
{
    // 4.1.1 Freespin bonus round scenario without wagering (held)
    #[Group('bonus')]
    #[ParentSuite('04. Gameslink Casino Tests (bonus flows)')]
    #[Suite('4.1 Free spins')]
    #[SubSuite('4.1.1 Freespin bonus round scenario without wagering (held)')]
